...
class MessageStream {
    ...
    static createMessage(messages, params, options) {
        ...
        runner._run(() => runner._createMessage(messages, { ...params, stream: true, 'anthropic-beta': 'messages-2023-12-15' }, { ...options, headers: { ...options?.headers, 'X-Stainless-Helper-Method': 'stream' } }));
        return runner;
    }
    _run(executor) {
        executor().then(() => {
    ...
    async _createMessage(messages, params, options) {
        ...
        const stream = await messages.create({ ...params, stream: true, 'anthropic-beta': 'messages-2023-12-15' }, { ...options, signal: this.controller.signal });
        this._connected();
